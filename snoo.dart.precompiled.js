...
["", "snoo.dart", , M, {
  "^": "",
  main: [function() {
    $.lvltex = document.querySelector("#lvltex");
    $.split = document.querySelector("#split");
    $.upper = document.querySelector("#upper");
    $.lower = document.querySelector("#lower");
    $.outer = document.querySelector("#overlay-outer");
    $.inner = document.querySelector("#overlay-inner");
    $.alien = document.querySelector("#reddit-alien");
    $.antenna = document.querySelector("#antenna");
    $.earLeft = document.querySelector("#ear-left");
    $.earRight = document.querySelector("#ear-right");
    $.head = document.querySelector("#alien-head");
    $.armLeft = document.querySelector("#arm-left");
    $.armRight = document.querySelector("#arm-right");
    $.abody = document.querySelector("#alien-body");
    $.footLeft = document.querySelector("#foot-left");
    $.footRight = document.querySelector("#foot-right");
    $.otext = document.querySelector("#otext");
    $.stext = document.querySelector("#stext");
    M.startGameClick();
  }, "call$0", "main$closure", 0, 0, 1],
  startGameClick: function() {
    var t1, t2, clickStart;
    t1 = {};
    t1.ready_0 = false;
    t1.timerIter_1 = 0;
    P.Timer_Timer(C.Duration_9600000, new M.startGameClick_closure(t1, C.Duration_800000));
    P.Timer_Timer$periodic(P.Duration$(0, 0, C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(C.Duration_800000._duration * 2)), 0, 0, 0), new M.startGameClick_closure0(t1, C.Duration_800000));
    t2 = J.get$onClick$x($.split);
    clickStart = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(M.ex$closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
    clickStart._tryResume$0();
    clickStart.onData$1(new M.startGameClick_closure1(t1, clickStart));
  },
  tearingMeApart: function() {
    J.set$transition$x($.alien.style, "0 !important");
    var t1 = J.get$onMouseDown$x($.earLeft);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.earRight);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.armLeft);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.armRight);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure2()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.footLeft);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure3()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.footRight);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure4()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.antenna);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure5()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.abody);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure6()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onMouseDown$x($.head);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.tearingMeApart_closure7()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  handleBodyPartClick: function(bodyPart, $event) {
    var t1, strm;
    t1 = $.head;
    if (bodyPart == null ? t1 != null : bodyPart !== t1) {
      t1 = $.abody;
      t1 = bodyPart == null ? t1 != null : bodyPart !== t1;
    } else
      t1 = false;
    if (t1 || $.countParts <= 0) {
      t1 = J.get$onMouseUp$x($.outer);
      strm = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(M.ex$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      strm._tryResume$0();
      strm.onData$1(new M.handleBodyPartClick_closure(bodyPart, $event, strm));
    }
  },
  doEndGame: function() {
    var e, imgwrap, t1, t2;
    J.insertAdjacentHtml$2$x(document.head, "beforeend", "<link rel=\"stylesheet\" href=\"end.css\">");
    e = document.createElement("img", null);
    J.set$src$x(e, "bloody-link2.gif");
    imgwrap = document.createElement("div", null);
    imgwrap.id = "imgwrap";
    t1 = J.getInterceptor$x(e);
    t2 = t1.get$onLoad(e);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.doEndGame_closure(e, imgwrap)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t1 = t1.get$onError(e);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.doEndGame_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  ex: [function($event) {
  }, "call$1", "ex$closure", 2, 0, 7],
  startGameClick_closure: {
    "^": "Closure:8;box_0,eightHun_1",
    call$0: function() {
      $.lvltex.textContent = "Done";
      var t1 = this.eightHun_1;
      P.Timer_Timer(t1, new M.startGameClick__closure0(this.box_0, t1));
    }
  },
  startGameClick__closure0: {
    "^": "Closure:8;box_0,eightHun_2",
    call$0: function() {
      $.lvltex.textContent = "Click anywhere";
      this.box_0.ready_0 = true;
      P.Timer_Timer(this.eightHun_2, new M.startGameClick___closure());
    }
  },
  startGameClick___closure: {
    "^": "Closure:8;",
    call$0: function() {
      J.set$transition$x($.lvltex.style, "all 1.8s ease-in-out");
      J.set$transform$x($.lvltex.style, "translateY(-900px)");
      P.Timer_Timer(C.Duration_1800000, new M.startGameClick____closure());
    }
  },
  startGameClick____closure: {
    "^": "Closure:8;",
    call$0: function() {
      return J.remove$0$ax($.lvltex);
    }
  },
  startGameClick_closure0: {
    "^": "Closure:22;box_0,eightHun_3",
    call$1: function(t) {
      J.get$classes$x($.outer).remove$1(0, "blurhue");
      J.get$classes$x($.alien).add$1(0, "tofront");
      P.Timer_Timer(this.eightHun_3, new M.startGameClick__closure(this.box_0, t));
    }
  },
  startGameClick__closure: {
    "^": "Closure:8;box_0,t_4",
    call$0: function() {
      J.get$classes$x($.outer).add$1(0, "blurhue");
      J.get$classes$x($.alien).remove$1(0, "tofront");
      if (++this.box_0.timerIter_1 >= 3)
        this.t_4.cancel$0();
    }
  },
  startGameClick_closure1: {
    "^": "Closure:10;box_0,clickStart_5",
    call$1: function(startGame) {
      if (this.box_0.ready_0) {
        this.clickStart_5.cancel$0();
        J.set$transform$x($.upper.style, "translateY(-2000px)");
        J.set$transform$x($.lower.style, "translateY(2000px)");
        P.Timer_Timer(C.Duration_2000000, new M.startGameClick__closure1(C.Duration_2000000));
        P.Timer_Timer(C.Duration_8000000, new M.startGameClick__closure2());
      }
    }
  },
  startGameClick__closure1: {
    "^": "Closure:8;twoSecs_6",
    call$0: function() {
      J.remove$0$ax($.upper);
      J.remove$0$ax($.lower);
      J.remove$0$ax($.split);
      P.Timer_Timer(this.twoSecs_6, new M.startGameClick___closure1());
    }
  },
  startGameClick___closure1: {
    "^": "Closure:8;",
    call$0: function() {
      J.set$opacity$x($.otext.style, "0");
      J.get$classes$x($.outer).remove$1(0, "blurhue");
      P.Timer_Timer(C.Duration_800000, new M.startGameClick____closure0());
      P.Timer_Timer(C.Duration_1500000, new M.startGameClick____closure1(C.Duration_800000, C.Duration_1500000));
    }
  },
  startGameClick____closure0: {
    "^": "Closure:8;",
    call$0: function() {
      return J.remove$0$ax($.otext);
    }
  },
  startGameClick____closure1: {
    "^": "Closure:8;eightHundredMillis_7,onehalfSecs_8",
    call$0: function() {
      J.set$opacity$x($.stext.style, "1");
      P.Timer_Timer(this.onehalfSecs_8, new M.startGameClick_____closure(this.eightHundredMillis_7));
    }
  },
  startGameClick_____closure: {
    "^": "Closure:8;eightHundredMillis_9",
    call$0: function() {
      J.set$transition$x($.stext.style, "all 0.8s ease-in-out");
      J.set$opacity$x($.stext.style, "0");
      P.Timer_Timer(this.eightHundredMillis_9, new M.startGameClick______closure());
    }
  },
  startGameClick______closure: {
    "^": "Closure:8;",
    call$0: function() {
      return J.remove$0$ax($.stext);
    }
  },
  startGameClick__closure2: {
    "^": "Closure:8;",
    call$0: function() {
      J.get$classes$x($.alien).add$1(0, "tofront");
      P.Timer_Timer(C.Duration_800000, new M.startGameClick___closure0());
    }
  },
  startGameClick___closure0: {
    "^": "Closure:8;",
    call$0: function() {
      return M.tearingMeApart();
    }
  },
  tearingMeApart_closure: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.earLeft, e);
    }
  },
  tearingMeApart_closure0: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.earRight, e);
    }
  },
  tearingMeApart_closure1: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.armLeft, e);
    }
  },
  tearingMeApart_closure2: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.armRight, e);
    }
  },
  tearingMeApart_closure3: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.footLeft, e);
    }
  },
  tearingMeApart_closure4: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.footRight, e);
    }
  },
  tearingMeApart_closure5: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.antenna, e);
    }
  },
  tearingMeApart_closure6: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.abody, e);
    }
  },
  tearingMeApart_closure7: {
    "^": "Closure:10;",
    call$1: function(e) {
      return M.handleBodyPartClick($.head, e);
    }
  },
  handleBodyPartClick_closure: {
    "^": "Closure:10;bodyPart_0,event_1,strm_2",
    call$1: function(e) {
      var t1, t2, t3, t4, t5, t6;
      this.strm_2.cancel$0();
      t1 = this.bodyPart_0;
      J.set$transition$x(t1.style, "all 0.2s linear");
      J.set$borderColor$x(t1.style, "#FFF");
      J.set$transition$x(t1.style, "all 1.8s");
      J.set$transitionTimingFunction$x(t1.style, "cubic-bezier(0.000, 1.000, 1.000, 1.000)");
      t2 = J.getInterceptor$x(e);
      t3 = J.get$x$x(t2.get$page(e));
      t4 = this.event_1;
      t5 = J.getInterceptor$x(t4);
      t6 = J.get$x$x(t5.get$page(t4));
      if (typeof t3 !== "number")
        return t3.$sub();
      if (typeof t6 !== "number")
        return H.iae(t6);
      t2 = J.get$y$x(t2.get$page(e));
      t4 = J.get$y$x(t5.get$page(t4));
      if (typeof t2 !== "number")
        return t2.$sub();
      if (typeof t4 !== "number")
        return H.iae(t4);
      J.set$left$x(t1.style, C.JSInt_methods.toString$0((t3 - t6) * 4) + "px");
      J.set$top$x(t1.style, C.JSInt_methods.toString$0((t2 - t4) * 4) + "px");
      J.set$opacity$x(t1.style, "0");
      P.Timer_Timer(C.Duration_2000000, new M.handleBodyPartClick__closure(t1));
      t1 = $.countParts - 1;
      $.countParts = t1;
      if (t1 === -2) {
        P.Timer_Timer(C.Duration_2000000, new M.handleBodyPartClick__closure0());
        M.doEndGame();
      }
    }
  },
  handleBodyPartClick__closure: {
    "^": "Closure:8;bodyPart_3",
    call$0: function() {
      return J.remove$0$ax(this.bodyPart_3);
    }
  },
  handleBodyPartClick__closure0: {
    "^": "Closure:8;",
    call$0: function() {
      return J.remove$0$ax($.alien);
    }
  },
  doEndGame_closure: {
    "^": "Closure:10;image_1,imgwrap_2",
    call$1: function(e) {
      var t1 = this.imgwrap_2;
      document.body.appendChild(t1);
      t1.appendChild(this.image_1);
      P.Timer_Timer(C.Duration_200000, new M.doEndGame__closure(t1));
    }
  },
  doEndGame__closure: {
    "^": "Closure:8;imgwrap_3",
    call$0: function() {
      ...
      t1 = {};
      t2 = this.imgwrap_3;
      J.set$opacity$x(t2.style, "1");
      speech = document.createElement("div", null);
      speech.id = "speech";
      t2.appendChild(speech);
      J.set$transform$x(speech.style, "scaleY(1)");
      speech.textContent = "T";
      t1.iterCount_0 = 1;
      P.Timer_Timer$periodic(C.Duration_10000, new M.doEndGame___closure(t1, t2, speech, "Thank you for saving me! I am the Github Link and that was Krov, an evil alien. He took Snoo's form in order to ruin his reputation.", C.Duration_200000, C.Duration_2000000));
    }
  },
  doEndGame___closure: {
    "^": "Closure:22;box_0,imgwrap_4,speech_5,speechText_6,sentenceTime_7,endTime_8",
    call$1: function(t) {
      var t1, t2, t3, t4, t5, t6;
      t1 = this.speechText_6;
      t2 = this.box_0;
      t3 = t2.iterCount_0;
      t4 = t3 - 1;
      t5 = t1.length;
      ...
      if (t4 !== "." && t4 !== "!" && t3 < t5) {
        ...
        if (typeof t4 !== "string")
          return t4.$add();
        t3.textContent = t4 + t6;
        ++t2.iterCount_0;
      } else {
        t4 = this.sentenceTime_7;
        t6 = this.speech_5;
        if (t3 < t5)
          P.Timer_Timer(t4, new M.doEndGame____closure(t2, t6, t1));
        else {
          P.Timer_Timer(this.endTime_8, new M.doEndGame____closure0(this.imgwrap_4, t6, t4));
          t.cancel$0();
        }
      }
    }
  },
  doEndGame____closure: {
    "^": "Closure:8;box_0,speech_9,speechText_10",
    call$0: function() {
      var t1, t2, t3, t4, t5;
      t1 = this.speech_9;
      t2 = J.get$text$x(t1);
      t3 = this.speechText_10;
      t4 = this.box_0;
      t5 = t4.iterCount_0;
      if (t5 >= t3.length)
      ...
      if (typeof t2 !== "string")
        return t2.$add();
      t1.textContent = t2 + t5;
      ++t4.iterCount_0;
    }
  },
  doEndGame____closure0: {
    "^": "Closure:8;imgwrap_11,speech_12,sentenceTime_13",
    call$0: function() {
      J.set$width$x($.outer.style, "20%");
      J.set$left$x(this.imgwrap_11.style, "0");
      var t1 = this.sentenceTime_13;
      P.Timer_Timer(P.Duration$(0, 0, C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t1._duration * 7)), 0, 0, 0), new M.doEndGame_____closure(this.speech_12, t1));
    }
  },
  doEndGame_____closure: {
    "^": "Closure:8;speech_14,sentenceTime_15",
    call$0: function() {
      var t1 = this.speech_14;
      J.set$transform$x(J.get$style$x(t1), "scaleY(0)");
      P.Timer_Timer(P.Duration$(0, 0, C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(this.sentenceTime_15._duration * 3)), 0, 0, 0), new M.doEndGame______closure(t1));
    }
  },
  doEndGame______closure: {
    "^": "Closure:8;speech_16",
    call$0: function() {
      var link1, t1, t2;
      link1 = W.AnchorElement_AnchorElement(null);
      t1 = J.getInterceptor$x(link1);
      t1.set$href(link1, "https://www.github.com/GeKorm");
      t2 = this.speech_16;
      J.set$innerHtml$x(t2, "Here's the Github!<div id=\"key\"></div>");
      document.querySelector("#key").appendChild(link1);
      t1.set$innerHtml(link1, "<img src=\"key.png\" id=\"keyimg\">");
      J.set$transform$x(t2.style, "scaleY(1)");
    }
  },
  doEndGame_closure0: {
    "^": "Closure:10;",
    call$1: function(e) {
      P.print("Couldn't load the link gif!");
    }
  }
},
1],
...
J.set$transitionTimingFunction$x = function(receiver, value) {
  return J.getInterceptor$x(receiver).set$transitionTimingFunction(receiver, value);
};
...
C.Duration_1800000 = new P.Duration(1800000);
C.Duration_200000 = new P.Duration(200000);
C.Duration_2000000 = new P.Duration(2000000);
C.Duration_800000 = new P.Duration(800000);
C.Duration_8000000 = new P.Duration(8000000);
C.Duration_9600000 = new P.Duration(9600000);
...
//# sourceMappingURL=snoo.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function startGameClick_closure(box_0, eightHun_1) {
    this.box_0 = box_0;
    this.eightHun_1 = eightHun_1;
  }
  startGameClick_closure.builtin$cls = "startGameClick_closure";
  if (!"name" in startGameClick_closure)
    startGameClick_closure.name = "startGameClick_closure";
  $desc = $collectedClasses.startGameClick_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick_closure.prototype = $desc;
  function startGameClick__closure0(box_0, eightHun_2) {
    this.box_0 = box_0;
    this.eightHun_2 = eightHun_2;
  }
  startGameClick__closure0.builtin$cls = "startGameClick__closure0";
  if (!"name" in startGameClick__closure0)
    startGameClick__closure0.name = "startGameClick__closure0";
  $desc = $collectedClasses.startGameClick__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick__closure0.prototype = $desc;
  function startGameClick___closure() {
  }
  startGameClick___closure.builtin$cls = "startGameClick___closure";
  if (!"name" in startGameClick___closure)
    startGameClick___closure.name = "startGameClick___closure";
  $desc = $collectedClasses.startGameClick___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick___closure.prototype = $desc;
  function startGameClick____closure() {
  }
  startGameClick____closure.builtin$cls = "startGameClick____closure";
  if (!"name" in startGameClick____closure)
    startGameClick____closure.name = "startGameClick____closure";
  $desc = $collectedClasses.startGameClick____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick____closure.prototype = $desc;
  function startGameClick_closure0(box_0, eightHun_3) {
    this.box_0 = box_0;
    this.eightHun_3 = eightHun_3;
  }
  startGameClick_closure0.builtin$cls = "startGameClick_closure0";
  if (!"name" in startGameClick_closure0)
    startGameClick_closure0.name = "startGameClick_closure0";
  $desc = $collectedClasses.startGameClick_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick_closure0.prototype = $desc;
  function startGameClick__closure(box_0, t_4) {
    this.box_0 = box_0;
    this.t_4 = t_4;
  }
  startGameClick__closure.builtin$cls = "startGameClick__closure";
  if (!"name" in startGameClick__closure)
    startGameClick__closure.name = "startGameClick__closure";
  $desc = $collectedClasses.startGameClick__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick__closure.prototype = $desc;
  function startGameClick_closure1(box_0, clickStart_5) {
    this.box_0 = box_0;
    this.clickStart_5 = clickStart_5;
  }
  startGameClick_closure1.builtin$cls = "startGameClick_closure1";
  if (!"name" in startGameClick_closure1)
    startGameClick_closure1.name = "startGameClick_closure1";
  $desc = $collectedClasses.startGameClick_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick_closure1.prototype = $desc;
  function startGameClick__closure1(twoSecs_6) {
    this.twoSecs_6 = twoSecs_6;
  }
  startGameClick__closure1.builtin$cls = "startGameClick__closure1";
  if (!"name" in startGameClick__closure1)
    startGameClick__closure1.name = "startGameClick__closure1";
  $desc = $collectedClasses.startGameClick__closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick__closure1.prototype = $desc;
  function startGameClick___closure1() {
  }
  startGameClick___closure1.builtin$cls = "startGameClick___closure1";
  if (!"name" in startGameClick___closure1)
    startGameClick___closure1.name = "startGameClick___closure1";
  $desc = $collectedClasses.startGameClick___closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick___closure1.prototype = $desc;
  function startGameClick____closure0() {
  }
  startGameClick____closure0.builtin$cls = "startGameClick____closure0";
  if (!"name" in startGameClick____closure0)
    startGameClick____closure0.name = "startGameClick____closure0";
  $desc = $collectedClasses.startGameClick____closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick____closure0.prototype = $desc;
  function startGameClick____closure1(eightHundredMillis_7, onehalfSecs_8) {
    this.eightHundredMillis_7 = eightHundredMillis_7;
    this.onehalfSecs_8 = onehalfSecs_8;
  }
  startGameClick____closure1.builtin$cls = "startGameClick____closure1";
  if (!"name" in startGameClick____closure1)
    startGameClick____closure1.name = "startGameClick____closure1";
  $desc = $collectedClasses.startGameClick____closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick____closure1.prototype = $desc;
  function startGameClick_____closure(eightHundredMillis_9) {
    this.eightHundredMillis_9 = eightHundredMillis_9;
  }
  startGameClick_____closure.builtin$cls = "startGameClick_____closure";
  if (!"name" in startGameClick_____closure)
    startGameClick_____closure.name = "startGameClick_____closure";
  $desc = $collectedClasses.startGameClick_____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick_____closure.prototype = $desc;
  function startGameClick______closure() {
  }
  startGameClick______closure.builtin$cls = "startGameClick______closure";
  if (!"name" in startGameClick______closure)
    startGameClick______closure.name = "startGameClick______closure";
  $desc = $collectedClasses.startGameClick______closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick______closure.prototype = $desc;
  function startGameClick__closure2() {
  }
  startGameClick__closure2.builtin$cls = "startGameClick__closure2";
  if (!"name" in startGameClick__closure2)
    startGameClick__closure2.name = "startGameClick__closure2";
  $desc = $collectedClasses.startGameClick__closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick__closure2.prototype = $desc;
  function startGameClick___closure0() {
  }
  startGameClick___closure0.builtin$cls = "startGameClick___closure0";
  if (!"name" in startGameClick___closure0)
    startGameClick___closure0.name = "startGameClick___closure0";
  $desc = $collectedClasses.startGameClick___closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startGameClick___closure0.prototype = $desc;
  function tearingMeApart_closure() {
  }
  tearingMeApart_closure.builtin$cls = "tearingMeApart_closure";
  if (!"name" in tearingMeApart_closure)
    tearingMeApart_closure.name = "tearingMeApart_closure";
  $desc = $collectedClasses.tearingMeApart_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure.prototype = $desc;
  function tearingMeApart_closure0() {
  }
  tearingMeApart_closure0.builtin$cls = "tearingMeApart_closure0";
  if (!"name" in tearingMeApart_closure0)
    tearingMeApart_closure0.name = "tearingMeApart_closure0";
  $desc = $collectedClasses.tearingMeApart_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure0.prototype = $desc;
  function tearingMeApart_closure1() {
  }
  tearingMeApart_closure1.builtin$cls = "tearingMeApart_closure1";
  if (!"name" in tearingMeApart_closure1)
    tearingMeApart_closure1.name = "tearingMeApart_closure1";
  $desc = $collectedClasses.tearingMeApart_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure1.prototype = $desc;
  function tearingMeApart_closure2() {
  }
  tearingMeApart_closure2.builtin$cls = "tearingMeApart_closure2";
  if (!"name" in tearingMeApart_closure2)
    tearingMeApart_closure2.name = "tearingMeApart_closure2";
  $desc = $collectedClasses.tearingMeApart_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure2.prototype = $desc;
  function tearingMeApart_closure3() {
  }
  tearingMeApart_closure3.builtin$cls = "tearingMeApart_closure3";
  if (!"name" in tearingMeApart_closure3)
    tearingMeApart_closure3.name = "tearingMeApart_closure3";
  $desc = $collectedClasses.tearingMeApart_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure3.prototype = $desc;
  function tearingMeApart_closure4() {
  }
  tearingMeApart_closure4.builtin$cls = "tearingMeApart_closure4";
  if (!"name" in tearingMeApart_closure4)
    tearingMeApart_closure4.name = "tearingMeApart_closure4";
  $desc = $collectedClasses.tearingMeApart_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure4.prototype = $desc;
  function tearingMeApart_closure5() {
  }
  tearingMeApart_closure5.builtin$cls = "tearingMeApart_closure5";
  if (!"name" in tearingMeApart_closure5)
    tearingMeApart_closure5.name = "tearingMeApart_closure5";
  $desc = $collectedClasses.tearingMeApart_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure5.prototype = $desc;
  function tearingMeApart_closure6() {
  }
  tearingMeApart_closure6.builtin$cls = "tearingMeApart_closure6";
  if (!"name" in tearingMeApart_closure6)
    tearingMeApart_closure6.name = "tearingMeApart_closure6";
  $desc = $collectedClasses.tearingMeApart_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure6.prototype = $desc;
  function tearingMeApart_closure7() {
  }
  tearingMeApart_closure7.builtin$cls = "tearingMeApart_closure7";
  if (!"name" in tearingMeApart_closure7)
    tearingMeApart_closure7.name = "tearingMeApart_closure7";
  $desc = $collectedClasses.tearingMeApart_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  tearingMeApart_closure7.prototype = $desc;
  function handleBodyPartClick_closure(bodyPart_0, event_1, strm_2) {
    this.bodyPart_0 = bodyPart_0;
    this.event_1 = event_1;
    this.strm_2 = strm_2;
  }
  handleBodyPartClick_closure.builtin$cls = "handleBodyPartClick_closure";
  if (!"name" in handleBodyPartClick_closure)
    handleBodyPartClick_closure.name = "handleBodyPartClick_closure";
  $desc = $collectedClasses.handleBodyPartClick_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  handleBodyPartClick_closure.prototype = $desc;
  function handleBodyPartClick__closure(bodyPart_3) {
    this.bodyPart_3 = bodyPart_3;
  }
  handleBodyPartClick__closure.builtin$cls = "handleBodyPartClick__closure";
  if (!"name" in handleBodyPartClick__closure)
    handleBodyPartClick__closure.name = "handleBodyPartClick__closure";
  $desc = $collectedClasses.handleBodyPartClick__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  handleBodyPartClick__closure.prototype = $desc;
  function handleBodyPartClick__closure0() {
  }
  handleBodyPartClick__closure0.builtin$cls = "handleBodyPartClick__closure0";
  if (!"name" in handleBodyPartClick__closure0)
    handleBodyPartClick__closure0.name = "handleBodyPartClick__closure0";
  $desc = $collectedClasses.handleBodyPartClick__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  handleBodyPartClick__closure0.prototype = $desc;
  function doEndGame_closure(image_1, imgwrap_2) {
    this.image_1 = image_1;
    this.imgwrap_2 = imgwrap_2;
  }
  doEndGame_closure.builtin$cls = "doEndGame_closure";
  if (!"name" in doEndGame_closure)
    doEndGame_closure.name = "doEndGame_closure";
  $desc = $collectedClasses.doEndGame_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame_closure.prototype = $desc;
  function doEndGame__closure(imgwrap_3) {
    this.imgwrap_3 = imgwrap_3;
  }
  doEndGame__closure.builtin$cls = "doEndGame__closure";
  if (!"name" in doEndGame__closure)
    doEndGame__closure.name = "doEndGame__closure";
  $desc = $collectedClasses.doEndGame__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame__closure.prototype = $desc;
  function doEndGame___closure(box_0, imgwrap_4, speech_5, speechText_6, sentenceTime_7, endTime_8) {
    this.box_0 = box_0;
    this.imgwrap_4 = imgwrap_4;
    this.speech_5 = speech_5;
    this.speechText_6 = speechText_6;
    this.sentenceTime_7 = sentenceTime_7;
    this.endTime_8 = endTime_8;
  }
  doEndGame___closure.builtin$cls = "doEndGame___closure";
  if (!"name" in doEndGame___closure)
    doEndGame___closure.name = "doEndGame___closure";
  $desc = $collectedClasses.doEndGame___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame___closure.prototype = $desc;
  function doEndGame____closure(box_0, speech_9, speechText_10) {
    this.box_0 = box_0;
    this.speech_9 = speech_9;
    this.speechText_10 = speechText_10;
  }
  doEndGame____closure.builtin$cls = "doEndGame____closure";
  if (!"name" in doEndGame____closure)
    doEndGame____closure.name = "doEndGame____closure";
  $desc = $collectedClasses.doEndGame____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame____closure.prototype = $desc;
  function doEndGame____closure0(imgwrap_11, speech_12, sentenceTime_13) {
    this.imgwrap_11 = imgwrap_11;
    this.speech_12 = speech_12;
    this.sentenceTime_13 = sentenceTime_13;
  }
  doEndGame____closure0.builtin$cls = "doEndGame____closure0";
  if (!"name" in doEndGame____closure0)
    doEndGame____closure0.name = "doEndGame____closure0";
  $desc = $collectedClasses.doEndGame____closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame____closure0.prototype = $desc;
  function doEndGame_____closure(speech_14, sentenceTime_15) {
    this.speech_14 = speech_14;
    this.sentenceTime_15 = sentenceTime_15;
  }
  doEndGame_____closure.builtin$cls = "doEndGame_____closure";
  if (!"name" in doEndGame_____closure)
    doEndGame_____closure.name = "doEndGame_____closure";
  $desc = $collectedClasses.doEndGame_____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame_____closure.prototype = $desc;
  function doEndGame______closure(speech_16) {
    this.speech_16 = speech_16;
  }
  doEndGame______closure.builtin$cls = "doEndGame______closure";
  if (!"name" in doEndGame______closure)
    doEndGame______closure.name = "doEndGame______closure";
  $desc = $collectedClasses.doEndGame______closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame______closure.prototype = $desc;
  function doEndGame_closure0() {
  }
  doEndGame_closure0.builtin$cls = "doEndGame_closure0";
  if (!"name" in doEndGame_closure0)
    doEndGame_closure0.name = "doEndGame_closure0";
  $desc = $collectedClasses.doEndGame_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  doEndGame_closure0.prototype = $desc;
  return [HtmlElement, AnchorElement, AnimationEvent, AreaElement, AudioElement, AutocompleteErrorEvent, BRElement, BaseElement, BeforeLoadEvent, BeforeUnloadEvent, BodyElement, ButtonElement, CDataSection, CanvasElement, CharacterData, CloseEvent, Comment, CompositionEvent, ContentElement, CssFontFaceLoadEvent, CssStyleDeclaration, CustomEvent, DListElement, DataListElement, DetailsElement, DeviceMotionEvent, DeviceOrientationEvent, DialogElement, DivElement, Document, DocumentFragment, DomError, DomException, DomImplementation, Element, EmbedElement, ErrorEvent, Event, EventTarget, FieldSetElement, FileError, FocusEvent, FormElement, HRElement, HashChangeEvent, HeadElement, HeadingElement, HtmlDocument, HtmlHtmlElement, IFrameElement, ImageElement, InputElement, InstallEvent, InstallPhaseEvent, KeyboardEvent, KeygenElement, LIElement, LabelElement, LegendElement, LinkElement, Location, MapElement, MediaElement, MediaError, MediaKeyError, MediaKeyEvent, MediaKeyMessageEvent, MediaKeyNeededEvent, MediaStream, MediaStreamEvent, MediaStreamTrackEvent, MenuElement, MessageEvent, MetaElement, MeterElement, MidiConnectionEvent, MidiInput, MidiMessageEvent, MidiOutput, MidiPort, ModElement, MouseEvent, Navigator, NavigatorUserMediaError, Node, NodeList, OListElement, ObjectElement, OptGroupElement, OptionElement, OutputElement, OverflowEvent, PageTransitionEvent, ParagraphElement, ParamElement, PopStateEvent, PositionError, PreElement, ProcessingInstruction, ProgressElement, ProgressEvent, QuoteElement, Range, ResourceProgressEvent, RtcDataChannelEvent, RtcDtmfToneChangeEvent, RtcIceCandidateEvent, ScriptElement0, SecurityPolicyViolationEvent, SelectElement, ShadowElement, ShadowRoot, SourceElement, SpanElement, SpeechInputEvent, SpeechRecognitionError, SpeechRecognitionEvent, SpeechSynthesisEvent, StorageEvent, StyleElement, TableCaptionElement, TableCellElement, TableColElement, TableElement, TableRowElement, TableSectionElement, TemplateElement, Text, TextAreaElement, TextEvent, TitleElement, TouchEvent, TrackElement, TrackEvent, TransitionEvent, UIEvent, UListElement, UnknownElement, VideoElement, WheelEvent, Window, XmlDocument, _Attr, _DocumentType, _HTMLAppletElement, _HTMLDirectoryElement, _HTMLFontElement, _HTMLFrameElement, _HTMLFrameSetElement, _HTMLMarqueeElement, _MutationEvent, _NamedNodeMap, _Notation, _XMLHttpRequestProgressEvent, VersionChangeEvent, AElement, AltGlyphElement, AnimateElement, AnimateMotionElement, AnimateTransformElement, AnimatedLength, AnimatedLengthList, AnimatedNumber, AnimatedNumberList, AnimationElement, CircleElement, ClipPathElement, DefsElement, DescElement, DiscardElement, EllipseElement, FEBlendElement, FEColorMatrixElement, FEComponentTransferElement, FECompositeElement, FEConvolveMatrixElement, FEDiffuseLightingElement, FEDisplacementMapElement, FEDistantLightElement, FEFloodElement, FEFuncAElement, FEFuncBElement, FEFuncGElement, FEFuncRElement, FEGaussianBlurElement, FEImageElement, FEMergeElement, FEMergeNodeElement, FEMorphologyElement, FEOffsetElement, FEPointLightElement, FESpecularLightingElement, FESpotLightElement, FETileElement, FETurbulenceElement, FilterElement, ForeignObjectElement, GElement, GeometryElement, GraphicsElement, ImageElement0, LineElement, LinearGradientElement, MarkerElement, MaskElement, MetadataElement, PathElement, PatternElement, PolygonElement, PolylineElement, RadialGradientElement, RectElement, ScriptElement, SetElement, StopElement, StyleElement0, SvgElement, SvgSvgElement, SwitchElement, SymbolElement, TSpanElement, TextContentElement, TextElement, TextPathElement, TextPositioningElement, TitleElement0, UseElement, ViewElement, ZoomEvent, _GradientElement, _SVGAltGlyphDefElement, _SVGAltGlyphItemElement, _SVGComponentTransferFunctionElement, _SVGCursorElement, _SVGFEDropShadowElement, _SVGFontElement, _SVGFontFaceElement, _SVGFontFaceFormatElement, _SVGFontFaceNameElement, _SVGFontFaceSrcElement, _SVGFontFaceUriElement, _SVGGlyphElement, _SVGGlyphRefElement, _SVGHKernElement, _SVGMPathElement, _SVGMissingGlyphElement, _SVGVKernElement, AudioProcessingEvent, OfflineAudioCompletionEvent, ContextEvent, SqlError, NativeTypedData, NativeUint8List, JS_CONST, Interceptor, JSBool, JSNull, JavaScriptObject, PlainJavaScriptObject, UnknownJavaScriptObject, JSArray, JSNumber, JSInt, JSDouble, JSString, startRootIsolate_closure, startRootIsolate_closure0, _Manager, _IsolateContext, _IsolateContext_handlePing_respond, _EventLoop, _EventLoop__runHelper_next, _IsolateEvent, _MainManagerStub, IsolateNatives__processWorkerMessage_closure, IsolateNatives__startIsolate_runStartFunction, _BaseSendPort, _NativeJsSendPort, _NativeJsSendPort_send_closure, _WorkerSendPort, RawReceivePortImpl, _JsSerializer, _JsCopier, _JsDeserializer, _JsVisitedMap, _MessageTraverserVisitedMap, _MessageTraverser, _Copier, _Copier_visitMap_closure, _Serializer, _Deserializer, TimerImpl, TimerImpl_internalCallback, TimerImpl_internalCallback0, TimerImpl$periodic_closure, CapabilityImpl, ReflectionInfo, TypeErrorDecoder, NullError, JsNoSuchMethodError, UnknownJsTypeError, unwrapException_saveStackTrace, _StackTrace, invokeClosure_closure, invokeClosure_closure0, invokeClosure_closure1, invokeClosure_closure2, invokeClosure_closure3, Closure, TearOffClosure, BoundClosure, RuntimeError, RuntimeType, RuntimeFunctionType, DynamicRuntimeType, TypeImpl, initHooks_closure, initHooks_closure0, initHooks_closure1, ListIterable, ListIterator, MappedIterable, EfficientLengthMappedIterable, MappedIterator, MappedListIterable, WhereIterable, WhereIterator, FixedLengthListMixin, _AsyncRun__initializeScheduleImmediate_internalCallback, _AsyncRun__initializeScheduleImmediate_closure, _AsyncRun__scheduleImmediateJsOverride_internalCallback, _AsyncError, _UncaughtAsyncError, Future, _Future, _Future__addListener_closure, _Future__chainForeignFuture_closure, _Future__chainForeignFuture_closure0, _Future__propagateToListeners_handleValueCallback, _Future__propagateToListeners_handleError, _Future__propagateToListeners_handleWhenCompleteCallback, _Future__propagateToListeners_handleWhenCompleteCallback_closure, _Future__propagateToListeners_handleWhenCompleteCallback_closure0, _AsyncCallbackEntry, Stream, Stream_forEach_closure, Stream_forEach__closure, Stream_forEach__closure0, Stream_forEach_closure0, Stream_length_closure, Stream_length_closure0, StreamSubscription, _EventSink, _DelayedEvent, _cancelAndError_closure, _cancelAndErrorClosure_closure, Timer, _Zone, _rootHandleUncaughtError_closure, _RootZone, _RootZone_bindCallback_closure, _RootZone_bindCallback_closure0, _RootZone_bindUnaryCallback_closure, _RootZone_bindUnaryCallback_closure0, _HashMap, _HashMap_values_closure, HashMapKeyIterable, HashMapKeyIterator, _LinkedHashMap, _LinkedHashMap_values_closure, LinkedHashMapCell, LinkedHashMapKeyIterable, LinkedHashMapKeyIterator, _LinkedHashSet, LinkedHashSetCell, LinkedHashSetIterator, _HashSetBase, IterableBase, ListBase, Object_ListMixin, ListMixin, Maps_mapToString_closure, ListQueue, _ListQueueIterator, SetMixin, SetBase, NoSuchMethodError_toString_closure, bool, $double, Duration, Duration_toString_sixDigits, Duration_toString_twoDigits, Error, NullThrownError, ArgumentError, RangeError, UnsupportedError, UnimplementedError, StateError, ConcurrentModificationError, StackOverflowError, CyclicInitializationError, _ExceptionImplementation, Expando, Function, $int, Iterator, List, Null, num, Object, StackTrace, String, StringBuffer, Symbol, Interceptor_CssStyleDeclarationBase, CssStyleDeclarationBase, Element_Element$html_closure, _ChildNodeListLazy, Interceptor_ListMixin, Interceptor_ListMixin_ImmutableListMixin, Interceptor_ListMixin0, Interceptor_ListMixin_ImmutableListMixin0, _AttributeMap, _ElementAttributeMap, _ElementCssClassSet, EventStreamProvider, _EventStream, _ElementEventStreamImpl, _EventStreamSubscription, _Html5NodeValidator, ImmutableListMixin, NodeValidatorBuilder, NodeValidatorBuilder_allowsElement_closure, NodeValidatorBuilder_allowsAttribute_closure, _SimpleNodeValidator, _TemplatingNodeValidator, _TemplatingNodeValidator_closure, _SvgNodeValidator, FixedSizeListIterator, NodeValidator, _SameOriginUriPolicy, _ValidatingTreeSanitizer, _ValidatingTreeSanitizer_sanitizeTree_walk, _AttributeClassSet, Capability, Point, NativeTypedArray, NativeTypedArrayOfInt, NativeTypedArray_ListMixin, NativeTypedArray_ListMixin_FixedLengthListMixin, CssClassSetImpl, CssClassSetImpl_add_closure, startGameClick_closure, startGameClick__closure0, startGameClick___closure, startGameClick____closure, startGameClick_closure0, startGameClick__closure, startGameClick_closure1, startGameClick__closure1, startGameClick___closure1, startGameClick____closure0, startGameClick____closure1, startGameClick_____closure, startGameClick______closure, startGameClick__closure2, startGameClick___closure0, tearingMeApart_closure, tearingMeApart_closure0, tearingMeApart_closure1, tearingMeApart_closure2, tearingMeApart_closure3, tearingMeApart_closure4, tearingMeApart_closure5, tearingMeApart_closure6, tearingMeApart_closure7, handleBodyPartClick_closure, handleBodyPartClick__closure, handleBodyPartClick__closure0, doEndGame_closure, doEndGame__closure, doEndGame___closure, doEndGame____closure, doEndGame____closure0, doEndGame_____closure, doEndGame______closure, doEndGame_closure0];
}
